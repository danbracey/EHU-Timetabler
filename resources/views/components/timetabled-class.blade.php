...
<div class="rounded-2xl bg-ehu-blue text-white">
    <h3 class="font-copse uppercase flex flex-row justify-center text-xl">CIS{{$timeslot->module_id}}: {{\App\Models\Module::where('id', '=', $timeslot->module_id)->first()->friendly_name}}</h3>
